...
export class Heading extends React.PureComponent<IProps> {
    render() {
        ...
        switch (this.props.type) {
            ...
            case 'h4':
                return <h4 className={classes}>{this.props.children}</h4>;
            case 'h5':
                return <h5 className={classes}>{this.props.children}</h5>;
            case 'h6':
                return <h6 className={classes}>{this.props.children}</h6>;
        }
    }
}
