...
export class CustomHeaderToggleBox extends React.PureComponent<IPropsCustomHeader, IState> {
    ...
    public toggle = (): Promise<boolean> => {
        return new Promise((resolve, reject) => {
            this.setState({isOpen: !this.state.isOpen, isAnimating: true}, () => {
    ...
    render() {
        ...
        return (
            <div className={classes} aria-expanded={isOpen} data-test-id="toggle-box">
                <div className="new-collapse-box__header">
                    <div className="new-collapse-box__header-inner">{this.props.header}</div>

                    <button className="new-collapse-box__divider" onClick={this.toggle} aria-controls={this.htmlId}>
