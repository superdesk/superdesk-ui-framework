...
export class AvatarContentImage extends React.PureComponent<IPropsImageAvatar> {
    render() {
        ...
        if (imageUrl == null) {
            return (
                <span {...maybeButtonProps} className="sd-avatar-content sd-avatar-content--dummy-img" title={tooltipText}>
            ...
            return (
                <span {...maybeButtonProps} className="sd-avatar-content" title={tooltipText}>
                    <img src={imageUrl} />
                </span>
            );
        }
