...
angular.module('superdesk-ui.helper.datepicker', ['superdesk-ui.helper.dateparser', 'superdesk-ui.helper.position']).constant('datepickerConfig', {
    formatDay: 'dd',
    formatMonth: 'MMMM',
    formatYear: 'yyyy',
    formatDayHeader: 'EEE',
    ...
    .controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$log', 'dateFilter', 'datepickerConfig', function($scope, $attrs, $parse, $interpolate, $log, dateFilter, datepickerConfig) {
        ...
        angular.forEach(['formatDay', 'formatMonth', 'formatYear', 'formatDayHeader', 'formatDayTitle', 'formatMonthTitle', 'minMode', 'maxMode', 'showWeeks', 'startingDay', 'yearRange', 'shortcutPropagation'], (key, index) => {
        ...
        if (angular.isDefined($attrs.initDate)) {
            ...
            $scope.$parent.$watch($attrs.initDate, (initDate) => {
        ...
        return {
            ...
            link: function link(scope, element, attrs, ngModel) {
                ...
                if (datepickerPopupConfig.html5Types[attrs.type]) {
                    ...
                    attrs.$observe('datepickerPopup', (value, oldValue) => {
                ...
                if (attrs.datepickerOptions) {
                    ...
                    angular.forEach(options, (value, option) => {
                        datepickerEl.attr(cameltoDash(option), value);
                    });
                }

                scope.watchData = {};
                angular.forEach(['minDate', 'maxDate', 'datepickerMode', 'initDate', 'shortcutPropagation'], (key) => {
                    if (attrs[key]) {
                ...
                var inputKeydownBind = function inputKeydownBind(evt) {
