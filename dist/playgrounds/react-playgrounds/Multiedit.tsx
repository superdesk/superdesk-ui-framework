                ...
                <Layout.AuthoringFrame
                            ...
                            <ButtonGroup align="end">
                                <ButtonGroup subgroup={true} spaces="no-space">
                                    ...
                                    <Tooltip text="Send to / Publish" flow="left">
                                        <NavButton
                                            type="darker"
                                            icon={this.state.sideBarOpen ? 'forward-thin' : 'backward-thin'}
                                            text="More actions"
                    ...
                    sidePanel={
                        <Layout.Panel side="right" background="grey" open={false} size="x-small">
                            <Layout.PanelHeader title="Pinned content" onClose={() => false}></Layout.PanelHeader>
                            <Layout.PanelContent>
                                <Layout.PanelContentBlock>
                                    <BoxedList density="comfortable">
                                        ...
                                        >
                                            <BoxedListContentRow>
                                                Maecenas sed diam eget risus varius blandit sit amet magna. Vestibulum
