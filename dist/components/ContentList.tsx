            ...
            <section className="docs-page__container">
                ...
                <PropsList>
                    <Prop
                        name="itemColum"
                        isRequired={true}
                        type="Array<{itemRow: Array<{content: any}>, border?: boolean, fullwidth?: boolean}>"
                        default="false"
                        description="An array of objects for defining column of individual items."
                    />
                    <Prop
                        name="action"
                        isRequired={false}
                        ...
                        default="false"
                        description="On hover displays an additional menu."
                    />
                    <Prop
                        name="locked"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="If is true, the individual item of list change state and change style."
                    />
                    <Prop
                        name="activated"
                        isRequired={false}
                ...
                <PropsList>
                    <Prop
                        name="itemRow"
                        isRequired={true}
                        type="Array<{content: any}>"
                        default="ture"
                        description="An array of objects for defining rows of individual items."
                    />
                    <Prop
                        name="border"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="If is true, the individual item of list change style."
                    />
                    <Prop
                        name="fullwidth"
                        isRequired={false}
