        ...
        return (
            <section className="docs-page__container">
                ...
                <p className="docs-page__paragraph">
                    Text info and illustrations for empty content areas in Superdesk.
                </p>
                ...
                <PropsList>
                    <Prop
                        ...
                        type="string"
                        default="false"
                        description="Title of the Empty state info block."
                    />
                    <Prop
                        name="description"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Additional information e.g. suggested actions etc."
                    />
                    <Prop
                        name="size"
                        isRequired={false}
                        type="small | large"
                        default="small"
                        description="Specifies the size and type of the illustration. Small should be used for narrow areas, like side panels, while large is suited for wider content areas. "
                    />
                    <Prop
                        name="illustration"
                        isRequired={false}
                        type="string"
                        default="1"
                        description="In combination with the size prop this defines the illustration. Possible values: 1, 2, 3 and dashboard (with size large only)."
                    />
                </PropsList>
            </section>
        );
