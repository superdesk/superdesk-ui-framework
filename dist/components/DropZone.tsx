                ...
                <Markup.ReactMarkup>
                    <Markup.ReactMarkupPreview>
                        ...
                        <div className="docs-page__content-row">
                            <DropZone text="Drag one or more files here to upload them, or just click on the field."></DropZone>
                        </div>
                        ...
                        <div className="docs-page__content-row">
                            <DropZone
                                ...
                                text="Drag one or more files here to upload them, or just click on the field."
                            ></DropZone>
                        </div>
