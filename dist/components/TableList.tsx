        ...
        return (
            <section className="docs-page__container">
                ...
                <p className="docs-page__paragraph">
                    Simple list without drag and drop functionality and without functionality for adding item in list:
                </p>
                <Markup.ReactMarkup>
                    <Markup.ReactMarkupPreview>
                        <TableList array={this.state.array} />
                    </Markup.ReactMarkupPreview>
                ...
                <PropsList>
                    ...
                    <Prop
                        ...
                        type="boolean"
                        default="false"
                        description="Functionality to add items to the list."
                    />
                    <Prop
                        name="dragAndDrop"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Drag&Drop functionality."
                    />
                    <Prop
                        name="className"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Add class on TableList container."
                    />
                    <Prop
                        name="showDragHandle"
                        isRequired={false}
                        type="string"
                        default="always"
                        description='"always" | "onHover" | "none".'
                    />
                    <Prop
                        name="readOnly"
                        isRequired={false}
                    ...
                    <Prop
                        ...
                        type="boolean"
                        default="false"
                        description="Set append to body on individual item while draging."
                    />
                    <Prop
                        name="onDrag"
                        isRequired={false}
                        type="function"
                        default="false"
                        description="Returns start and end position of draggable item"
                    />
                    <Prop
                        name="onAddItem"
                        isRequired={false}
                        type="function"
                        default="false"
                        description="Returns index of draggable item."
                    />
                    <Prop
                        name="itemsDropdown"
                        isRequired={false}
                        type="function"
                        default="false"
                        description="Dropdown for adding items in the list. Returns index of draggable item."
                    />
                </PropsList>
                ...
                <PropsList>
                    <Prop
                        ...
                        default="false"
                        description="Column of individual items of list."
                    />
                    <Prop
                        name="center"
                        isRequired={false}
                    ...
                    <Prop
                        ...
                        type="React.ReactNode"
                        default="false"
                        description="Column of individual list items that is displayed on hover."
                    />
                    <Prop
                        name="hexColor"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Color of left border for item status."
                    />
                    <Prop
                        name="locked"
                        isRequired={false}
                        type="function"
                        default="false"
                        description="If is true, the individual item of list change state and change style (border)."
                    />
                    <Prop
                        name="positionLocked"
                        isRequired={false}
                    ...
                    <Prop
                        ...
                        type="function"
                        default="false"
                        description="onClick functionality."
                    />
                    <Prop
                        name="onDoubleClick"
                        isRequired={false}
                        type="function"
                        default="false"
                        description="onDoubleClick functionality."
                    />
                </PropsList>
            </section>
        );
