        ...
        return (
            <section className="docs-page__container">
                ...
                <p className="docs-page__paragraph">
                    This is minimal required configuration for Carousel. You need to define <code>images</code> as array
                    of image links.
                </p>
                <Markup.ReactMarkup>
...
<Carousel images={images}></Carousel>
                ...
                <p className="docs-page__paragraph">
                    This is carousel with all possible options (<code>title</code>, <code>description</code>,{' '}
                    <code>actions</code>...)
                </p>
                <Markup.ReactMarkup>
                    <Markup.ReactMarkupPreview>
                ...
                <PropsList>
                    <Prop
                        ...
                        default="null"
                        description="An array of images to display"
                    />
                    ...
                    <Prop
                        ...
                        type="number"
                        default="null"
                        description="If there are more images in gallery than what is visible you can set total count here."
                    />
                    <Prop
                        name="headerMeta"
                        isRequired={false}
                        type="JSX.Element"
                        default="null"
                        description="Additional metadata section displayed top right if provided"
                    />
                    <Prop
                        name="id"
                        isRequired={false}
