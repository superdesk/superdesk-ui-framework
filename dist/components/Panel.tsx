            ...
            <section className="docs-page__container">
                    ...
                    <Markup.ReactMarkupPreview>
                        ...
                        <div
                            ...
                            style={{
                                ...
                                backgroundColor: 'var(--sd-colour-panel-bg--100)',
                                maxHeight: '400px',
                            }}
                        >
                            {this.state.openPanel1 ? null : (
                                <div className="d-flex items-center justify-center sd-flex--grow">
                                    <Button
                                        text="Open Panel"
                                        style="filled"
                                        onClick={() => this.setState({openPanel1: true})}
                                    />
                                </div>
                            )}
                            <PanelElements.Panel
                            ...
                            >
                                ...
                                <PanelElements.PanelContent>
                                    <PanelElements.PanelContentBlock>
                                        <p className="sd-margin-b--2">
                                            Maecenas sed diam eget risus varius blandit sit amet non magna. Lorem ipsum
                                            dolor sit amet, consectetur adipiscing elit. Maecenas faucibus mollis
                                            interdum. Cras justo odio, dapibus ac facilisis in, egestas eget quam.
                                        ...
                                        <p>
                                            ...
                                            magna mollis euismod. Aenean eu leo quam. Pellentesque ornare sem lacinia
                                            quam venenatis vestibulum. Nullam quis risus eget urna mollis ornare vel eu
                                            leo. Curabitur blandit tempus porttitor. Aenean lacinia bibendum nulla sed
                                            consectetur.
                                        </p>
                                    </PanelElements.PanelContentBlock>
                                </PanelElements.PanelContent>
                            ...
                            {this.state.openPanel2 ? null : (
                                <div className="d-flex items-center justify-center sd-flex--grow">
                                    <Button
                                        text="Open Panel"
                                        style="filled"
                                        onClick={() => this.setState({openPanel2: true})}
                                    />
                                </div>
                            )}
                            <PanelElements.Panel
                                side="right"
                                background="light"
                                open={this.state.openPanel2}
                                size="small"
                                theme="dark"
                            >
                                <PanelElements.PanelHeader
                                    title="Right panel title"
                                    onClose={() => this.setState({openPanel2: false})}
                                ...
                                <PanelElements.PanelContent>
                                    <PanelElements.PanelContentBlock>
                                        <p className="sd-margin-b--2">
                                            ...
                                            adipiscing elit. Donec sed odio dui. Aenean eu leo quam. Pellentesque ornare
                                        ...
                                        <p className="sd-margin-b--2">
                                            ...
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras justo odio,
                                            dapibus ac facilisis in, egestas eget quam. Duis mollis, est non commodo
                                            luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.
                                            Vestibulum id ligula porta felis euismod semper.
                                        </p>
                                        <p>
                                            Aenean lacinia bibendum nulla sed consectetur. Cum sociis natoque penatibus
                                            et magnis dis parturient montes, nascetur ridiculus mus. Etiam porta sem
                                            malesuada magna mollis euismod. Integer posuere erat a ante venenatis
                                            dapibus posuere velit aliquet. Praesent commodo cursus magna, vel
                            ...
                            {this.state.openPanel3 ? null : (
                                <div className="d-flex items-center justify-center sd-flex--grow">
                                    <Button
                                        text="Open Panel"
                                        style="filled"
                                        onClick={() => this.setState({openPanel3: true})}
                                    />
                                </div>
                            )}
                            <PanelElements.Panel
                                side="left"
                                background="light"
                                open={this.state.openPanel3}
                                size="small"
                            >
                                <PanelElements.PanelHeader
                                    title="Donec sed odio dui"
                                    onClose={() => this.setState({openPanel3: false})}
                                >
                                        ...
                                        <PanelElements.PanelHeaderSlidingToolbar>
                                            <ButtonGroup align="end">
                                                <Button
                                                    text="Cancel"
                                                    style="hollow"
                                                    onClick={() => this.setState({openToolbar1: false})}
                                                />
                                                <Button
                                                    text="Save"
                                                    style="hollow"
                                ...
                                <PanelElements.PanelContent>
                                    <PanelElements.PanelContentBlock>
                                        <p className="sd-margin-b--2">
                                            ...
                                            fermentum massa justo sit amet risus. Donec id elit non mi porta gravida at
                                            eget metus. Nulla vitae elit libero, a pharetra augue. Maecenas faucibus
                                            mollis interdum. Vivamus sagittis lacus vel augue laoreet rutrum faucibus
                                ...
                                <PanelElements.PanelFooter>
                                    {this.state.openToolbar1 ? null : (
                                        <ButtonGroup align="start">
                                            <Button
                                                text="Open Slide In Toolbar"
                                                style="hollow"
                                                onClick={() => this.setState({openToolbar1: true})}
                                            />
                                        </ButtonGroup>
                                    )}
                                    <ButtonGroup align="end">
                            ...
                            {this.state.openPanel4 ? null : (
                                <div className="d-flex items-center justify-center sd-flex--grow">
                                    <Button
                                        text="Open Panel"
                                        style="filled"
                                        onClick={() => this.setState({openPanel4: true})}
                                    />
                                </div>
                            )}
                            <PanelElements.Panel
                                side="left"
                                background="light"
                                open={this.state.openPanel4}
                                size="x-small"
                                theme="dark"
                            >
                                <PanelElements.PanelHeader title="Donec sed odio dui">
                                    <PanelElements.PanelTools
                                        tools={[
                                            ...
                                            {title: 'Edit', icon: 'pencil', onClick: () => false, ariaValue: 'Edit'},
                                            {
                                                title: 'Close',
                                                icon: 'close-small',
                                                onClick: () => this.setState({openPanel4: false}),
                                                ariaValue: 'Close',
                                            },
                                        ]}
                                    />
                                ...
                                <PanelElements.PanelContent>
                                    <PanelElements.PanelContentBlock>
                                        <p className="sd-margin-b--2">
                                            Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut
                                            fermentum massa justo sit amet risus. Donec id elit non mi porta gravida at
                                            eget metus. Nulla vitae elit libero, a pharetra augue.
                                        </p>
                                        <p>
                                            Donec ullamcorper nulla non metus auctor fringilla. Cras mattis consectetur
                                            purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.
                ...
                <PropsList>
                    <Prop
                        name="size"
                        isRequired={false}
                        type="xx-small | x-small | small | medium | large | x-large | xx-large  | xxx-large  | full | auto"
                        default="small"
                        description="Specifies the width of the panel."
                    />
                    <Prop
                        name="side"
                        isRequired={false}
                        type="left | right"
                        default="left"
                        description="Defines the side of the panel. It will also add the appropriate shadow on the opsite side."
                    />
                    <Prop
                        name="theme"
                        isRequired={false}
                        type="light | dark"
                        default="/"
                        description="Explicitly define the theme of the panel. All child elements and the content will inherit the selected theme."
                    />
                    <Prop
                        name="background"
                        isRequired={false}
                        type="transparent | light | grey"
                        default="light"
                        description="Background colour of the panel."
                    />
                    <Prop
                        name="open"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Toggles the open/closed state of the panel."
                    />
                    <Prop
                        name="ClassName"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Add custom classes to modify the default behaviour or specify the placement in complex layouts."
                    />
                </PropsList>
                ...
                <PropsList>
                    <Prop
                        ...
                        type="string"
                        default="/"
                        description="Specifies the title of the panel."
                    />
                    <Prop
                        name="theme"
                        isRequired={false}
                        type="light | dark"
                        default="/"
                        description="Explicitly define the theme just for the of Panel Header. All child elements and the content inside the Header will inherit the selected theme."
                    />
                    <Prop
                        name="color"
                        isRequired={false}
                        ...
                        default="light"
                        description="Background colour of the Panel Header. blueGrey and blueGreyDarker will also change the text colour to white."
                    />
                    <Prop
                        name="ClassName"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Add custom or helper classes to modify the default behaviour if needed. Use only if necessary."
                    />
                    <Prop
                        name="iconButtons"
                        isRequired={false}
                        type="Aarray"
                        default="false"
                        description="Array of JSX Elements."
                    />
                </PropsList>
                ...
                <PropsList>
                    ...
                    <Prop
                        ...
                        type="ReactNode"
                        default="/"
                        description="Use the EmptyState component to define the image and text for the empty state."
                    />
                </PropsList>
                ...
                <PropsList>
                    <Prop
                        ...
                        type="boolean"
                        default="false"
                        description="Change to flex display mode."
                    />
                    <Prop
                        name="padding"
                        isRequired={false}
                        type="0 | 1-5 | 3"
                        default="2"
                        description="Choose padding for the content block. Defaults to 2 (16px) without specifiying a value."
                    />
                    <Prop
                        name="ClassName"
                        isRequired={false}
                        type="string"
                        default="false"
                        description="Add custom or helper classes to modify the default behaviour or layout if needed."
                    />
                </PropsList>
            </section>
        );
