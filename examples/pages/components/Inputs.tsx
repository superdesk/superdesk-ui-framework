            ...
            <section className="docs-page__container">
                ...
                <PropsList>
                    ...
                    <Prop
                        ...
                        default="text"
                        description="Input type. Defaults to type text."
                    />
                    <Prop
                        name="maxLength"
                        isRequired={false}
                        type="number"
                        default="/"
                        description="Sets max length for input text."
                    />
                    <Prop
                        name="placeholder"
                        isRequired={false}
                        type="string"
                        default="/"
                        description="Defines the text for the placeholder pseudo-element."
                    />
                    <Prop
                        name="fullWidth"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Forces the input to take 100% of the container width."
                    />
                    <Prop
                        name="boxedStyle"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Applies a boxed style to the input. This style should be used only in the authoring enviroment and similar."
                    />
                    <Prop
                        name="boxedLable"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Applies a boxed style to the input label. This label style should be used only in combination with the boxedStyle input inside the authoring enviroment."
                    />
                    <Prop
                        name="size"
                        isRequired={false}
                        ...
                        default="medium"
                        description="Specifies the size of the input. Defaults to medium and should be changed only in special cases (e.g. titles, headlines etc.)."
                    />
                    <Prop
                        name="onChange"
                        isRequired={true}
