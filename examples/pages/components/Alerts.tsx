        ...
        return (
            <section className="docs-page__container">
                ...
                <p className="docs-page__paragraph">
                    Provide contextual feedback or info messages for user actions with the handful of available alert
                    box options.
                </p>
                ...
                <Markup.ReactMarkup>
                    <Markup.ReactMarkupPreview>
                        ...
                        <Alert style="hollow" size="normal" restoreIcon="info">
                            Fusce nec ex et dolor rhoncus iaculis maximus sit amet lorem. Nunc posuere, ligula quis
                            dictum tempor, lectus diam pharetra est, id fringilla leo urna vel arcu.
                        </Alert>
                        <Alert icon="info-sign" style="hollow" size="normal" type="primary" restoreIcon="info">
                            Integer elementum vestibulum ipsum a rhoncus. Cras et tortor tempus, imperdiet neque sit
                            amet, imperdiet elit. Nunc eleifend sollicitudin molestie. Aliquam nec enim orci.
                        </Alert>
                        <Alert icon="warning-sign" style="hollow" size="normal" type="warning" restoreIcon="info">
                            Sed tincidunt ipsum metus, consectetur vestibulum turpis luctus in. Vestibulum ut ex
                            vulputate, lacinia mauris vel, accumsan libero. Morbi dapibus non felis et convallis. Sed at
                            dolor vel nisl aliquam vehicula.
                        </Alert>
                        ...
                        <Alert style="hollow" size="normal" type="sd-green" restoreIcon="help">
                            In mattis tellus odio, quis dictum sapien pellentesque in. Phasellus dignissim tempus ante
                            at congue. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis maximus bibendum
                            lacinia.
                        </Alert>
                        ...
                        <Alert icon="exclamation-sign" style="filled" size="normal" restoreIcon="info">
                            Nullam quis risus eget urna mollis ornare vel eu leo. Praesent commodo cursus magna, vel
                        ...
                        <Alert style="filled" size="normal" type="primary" restoreIcon="info">
                            ...
                            illum dolore eu feugiat nulla facilisis. Praesent vulputate eros nisi, et porta magna
                            eleifend et.
                        </Alert>
                        <Alert icon="warning-sign" style="filled" size="normal" type="warning" restoreIcon="info">
                            Praesent vulputate eros nisi, et porta magna eleifend et. Duis non sagittis erat. Nulla
                        ...
                        <Alert style="filled" size="normal" type="success" restoreIcon="info">
                            Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Nulla vitae elit
                            libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl consectetur
                            et.
                        </Alert>
                        ...
                        <Alert style="filled" size="normal" type="sd-green" restoreIcon="info">
                            ...
                            ut id elit. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at
                        ...
                        <Alert icon="info-sign" style="hollow" size="small" type="primary" restoreIcon="info">
                            Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Fusce
                            dapibus, tellus ac cursus.
                        </Alert>
                        <Alert style="filled" size="small" type="highlight" restoreIcon="info">
                            Maecenas sed diam eget risus varius blandit sit amet non magna. Curabitur blandit tempus
                            porttitor. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec
                ...
                <p className="docs-page__paragraph">
                    The Alert component can be placed inside other elements, in this example inside the{' '}
                    <code>PanelHeader</code>, to alert the user about important information relevant to this specific
                    area of the application. In areas that are limited in space set the <code>banner</code> prop to
                    true. This will strip all margins and the border-radius from the component. Hollow style is not
                    recommended in this case, and small size is advised.
                </p>
                <Markup.ReactMarkup>
                    <Markup.ReactMarkupPreview>
                        <div
                ...
                <PropsList>
                    ...
                    <Prop
                        ...
                        type="filled | hollow"
                        default="filled"
                        description="Alerts may be one of styles such as hollow alerts, alerts without background (text-only) or default filled."
                    />
                    <Prop
                        name="size"
                        isRequired={false}
                        type="normal | small"
                        default="normal"
                        description="Choose between a normal or small alert."
                    />
                    <Prop
                        name="margin"
                        isRequired={false}
                        ...
                        default="normal"
                        description="Specifies the bottom margin of the alert."
                    />
                    <Prop
                        name="icon"
                        isRequired={false}
                        type="string"
                        default="-"
                        description="Adds an icon at the beggining of the alert dialogue. To specify na icon use the names from the Icon component."
                    />
                    <Prop
                        name="banner"
                        isRequired={false}
                        type="boolean"
                        default="false"
                        description="Setting to true will remove the box-shadow and border-radius. Use this option to display the alert in toolbars and similar."
                    />
