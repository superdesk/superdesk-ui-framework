    ...
    render() {
        ...
        return (
            <section className="docs-page__container">
                ...
                <PropsList>
                    <Prop name='groups' isRequired={true} type='Array<groups>' default='/' description='Array of groups'/>
                    <Prop name='ariaLabel' isRequired={false} type='string' default='/' description='Text value for the aria-label.'/>
                    <Prop name='activeItemId' isRequired={true} type='string' default='/' description='ID of the item that is active by default.'/>
                    <Prop name='groups label' isRequired={true} type='string' default='/' description='Group label text value.'/>
                    <Prop name='groups items' isRequired={true} type='Array<menuitem>' default='/' description='Array of items in the group.'/>
                    <Prop name='items id' isRequired={true} type='string' default='/' description='Menu item id value'/>
                    <Prop name='items label' isRequired={true} type='string' default='/' description='Menu item text value.'/>
                    <Prop name='items ref' isRequired={true} type='string' default='/' description='Works in corelation with the scrollspy. It must be the same as the ID of the element/section the click should lead to.'/>
                    ...
                    <Prop name='reverseItemBorder' isRequired={false} type='boolean' default='false' description='Moves the border of the active item to the left side.'/>
                    <Prop name='style' isRequired={false} type='default | inverse | blanc' default='default' description='Sets the style of the menu.'/>
                    <Prop name='size' isRequired={false} type='medium | large' default='medium' description='Sets the width of the menu. Default value is medium.'/>
                </PropsList>
            </section>
        )
    }
