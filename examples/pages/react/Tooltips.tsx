        ...
        return (
            <section className="docs-page__container">
                ...
                <Markup.ReactMarkupCodePreview>{`
                    <Tooltip text="top" tooltip='{{text:"I'm on top"}}'/>
                `}
                </Markup.ReactMarkupCodePreview>
                <Markup.ReactMarkup>
                    ...
                    <Markup.ReactMarkupCode>{`
                        <Tooltip text="top" tooltip='{{text:"I'm on top"}}'/>
                        <Tooltip text="bottom" tooltip='{{text:"I'm at the Bottom",flow:"down"}}'/>
                        <Tooltip text="left" tooltip='{{text:"I open on the left",flow:"left"}}'/>
                        <Tooltip text="right" tooltip='{{text:"Right on!", flow:"right"}}'/>
                    `}
                    </Markup.ReactMarkupCode>
                </Markup.ReactMarkup>
            </section>
