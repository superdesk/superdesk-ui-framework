        ...
        return (
            <section className="docs-page__container">
                ...
                <Markup.ReactMarkup>
                    ...
                    <Alert style='hollow' size='normal' icon='info'>
                    ...
                    <Alert style='hollow' size='normal' type='sd-green' icon='help'>
                    ...
                    <Alert style='hollow' size='normal' type='primary' icon='info'>
                    ...
                    <Alert style='filled' size='normal' type='sd-green' icon='info'>
                    ...
                    <Alert style='filled' size='normal' type='warning' icon='info'>
                    ...
                    <Alert style='hollow' size='small' type='primary' icon='info'>
                    ...
                    <Alert style='filled' size='small' type='highlight' icon='info'>
