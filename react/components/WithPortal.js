...
function findParent(element) {
    ...
    while (
        dataTheme != null &&
        (dataTheme === null || dataTheme === void 0 ? void 0 : dataTheme.getAttribute('data-theme')) == null
    ) {
...
var WithPortal = /** @class */ (function (_super) {
    ...
    WithPortal.prototype.componentDidMount = function () {
        ...
        this.dataTheme =
            (_b =
                (_a = findParent(this.ref.current)) === null || _a === void 0
                    ? void 0
                    : _a.getAttribute('data-theme')) !== null && _b !== void 0
                ? _b
                : undefined;
    };
        ...
        return React.createElement(
            ...
            this.props.active &&
                (0, react_dom_1.createPortal)(
                    React.createElement(
                        'div',
                        {'data-theme': this.dataTheme, 'data-test-id': this.props['data-test-id']},
                        this.props.children,
                    ),
                    document.body,
                ),
