        ...
        return React.createElement(TooltipWrapper, {tooltipText: this.props.tooltip}, function (_a) {
            ...
            return React.createElement(
                ...
                __assign({}, attributes, {
                    ...
                    className: classes,
                    tabIndex: 0,
                    disabled: _this.props.disabled || _this.props.isLoading,
                    'data-loading': _this.props.isLoading,
                    onClick: _this.props.disabled
                        ? function () {
                              return false;
                          }
                        : function (event) {
                    ...
                    'aria-label': _this.props.iconOnly ? _this.props.text : '',
                    'data-test-id': _this.props['data-test-id'],
                    style: _this.props.noMargin ? {margin: 0} : undefined,
                }),
                _this.props.isLoading ? React.createElement(Spinner_1.Spinner, {size: 'mini'}) : null,
                _this.props.icon && !_this.props.isLoading
                    ? React.createElement(Icon_1.Icon, {ariaHidden: true, name: _this.props.icon})
                    : null,
