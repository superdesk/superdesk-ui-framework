...
var Time = /** @class */ (function (_super) {
    ...
    Time.prototype.render = function () {
        var _a;
        var classes = (0, classnames_1.default)('sd-time', (_a = {
            ...
            _a["sd-font-size--".concat(this.props.size)] = this.props.size && this.props.size !== 'x-small',
            _a[''] = this.props.color === undefined,
            _a["sd-text-color--".concat(this.props.color)] = this.props.color && this.props.color !== 'normal',
            _a), this.props.className);
        return (React.createElement("time", { dateTime: this.props.datetime, className: classes }, this.props.children));
    };
    return Time;
}(React.PureComponent));
exports.Time = Time;
