...
var Dropdown = function (_a) {
        ...
        if (header && footer) {
            ...
            return React.createElement(
                'ul',
                {
                    ...
                    role: 'menu',
                    ref: ref,
                    style: __assign({zIndex: zIndex, overflowY: 'auto'}, maxHeightStyle),
                },
                dropdownElements,
            );
        }
    ...
    function each(item, index) {
        if (item['type'] === 'submenu') {
            ...
            return React.createElement(DropdownItemWithSubmenu, {
                key: index,
                index: index,
                item: item,
                menuID: menuID,
                subMenuItems: submenuItems_1,
                onChange: onChange,
            });
    ...
    return React.createElement(
        ...
        typeof children === 'object'
            ? React.isValidElement(children)
                ? React.createElement(
                      'div',
                      {ref: buttonRef, style: {display: 'content'}},
                      (function () {
                          var attrs = {
...
var DropdownItem = function (_a) {
    ...
    return React.createElement(
        'li',
        {role: 'none', className: active ? 'dropdown__menu-item--active' : ''},
        React.createElement(
            'button',
            {
                tabIndex: 0,
...
var DropdownItemWithSubmenu = function (_a) {
    ...
    return React.createElement(
        'li',
        {key: index, ref: refButtonSubMenu},
        React.createElement(
            'div',
            {
                className: 'dropdown',
            ...
            React.createElement(
                'ul',
                {role: 'menu', ref: refSubMenu, style: {display: 'none'}, className: 'dropdown__menu'},
                subMenuItems,
            ),
        ),
    );
