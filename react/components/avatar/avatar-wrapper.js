...
var AvatarWrapper = /** @class */ (function (_super) {
    ...
    AvatarWrapper.prototype.render = function () {
        ...
        return (React.createElement("span", { className: (0, classnames_1.default)('sd-avatar', {
            ...
            this.props.children,
            ((_c = this.props.administratorIndicator) === null || _c === void 0 ? void 0 : _c.enabled) === true ? (React.createElement("i", { className: "icon-settings sd-avatar--indicator-admin", title: this.props.administratorIndicator.tooltipText })) : null,
