...
var AvatarGroup = /** @class */ (function (_super) {
    ...
    AvatarGroup.prototype.render = function () {
        ...
        var someIconsHaveExtraElements = items.filter(isAvatar).some(function (_a) {
            var icon = _a.icon,
                administratorIndicator = _a.administratorIndicator;
        ...
        var someHaveDisplayName = this.props.items.some(function (item) {
            return isAvatar(item) && item.displayName.length > 0;
        });
        return React.createElement(
            WithPopover_1.WithPopover,
            {
                    ...
                    return React.createElement(
                        ...
                        _this.props.items.map(function (item, index) {
                            return someHaveDisplayName
                                ? React.createElement(
                                      common_1.Spacer,
                                      {h: true, alignItems: 'center', gap: '16', noGrow: true, key: index},
                                      ...
                                      isAvatar(item)
                                          ...
                                          : React.createElement(avatar_placeholder_1.AvatarPlaceholder, {
                                                kind: 'plus-button',
                                                size: 'small',
                                                icon: item.icon,
                ...
                return React.createElement(
                    'div',
                    {
                        className: (0, classnames_1.default)(
                            ...
                            'sd-avatar-group--stacked--gap-'.concat(gap),
                        ),
                        role: 'group',
                    ...
                    items.slice(0, max).map(function (item, index) {
                        if (isAvatar(item)) {
                            ...
                            return React.createElement(
                                avatar_placeholder_1.AvatarPlaceholder,
                                __assign({}, item, {key: index, size: _this.props.size}),
                            );
                        }
                    }),
                    itemsOverLimit > 0 &&
                        React.createElement(
                            ...
                            {onToggle: onToggle},
                            React.createElement(
                                avatar_wrapper_1.AvatarWrapper,
                                {size: size},
                                React.createElement(avatar_number_1.AvatarContentNumber, {
                                    number: ''.concat(itemsOverLimit),
                                }),
                            ),
                        ),
                );
