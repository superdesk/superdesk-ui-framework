...
var Avatar = /** @class */ (function (_super) {
    ...
    Avatar.prototype.render = function () {
        var _a = this.props,
            ...
            size = _a.size,
            statusIndicator = _a.statusIndicator,
            administratorIndicator = _a.administratorIndicator,
            icon = _a.icon,
            noAvatarPlaceholderColor = _a.noAvatarPlaceholderColor,
            displayName = _a.displayName,
            customContent = _a.customContent,
            statusDot = _a.statusDot;
        var tooltipCombined = [displayName, this.props.tooltip]
            .filter(function (str) {
                return (str !== null && str !== void 0 ? str : '').trim().length > 0;
            })
            .join('\n');
        return React.createElement(
            ...
            (function () {
                if (customContent != null) {
                    ...
                    return React.createElement(avatar_image_1.AvatarContentImage, {
                        imageUrl: imageUrl,
                        tooltipText: tooltipCombined,
                    });
                } else {
                    return React.createElement(avatar_text_1.AvatarContentText, {
                        text: initials,
                        tooltipText: tooltipCombined,
                    });
                }
