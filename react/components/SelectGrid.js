...
var SelectGrid = /** @class */ (function (_super) {
    ...
    function SelectGrid(props) {
        ...
        _this.hidePopupAndRefocus = function () {
            ...
            (_a = _this.overlayPanel.current) === null || _a === void 0 ? void 0 : _a.hide();
            (_c =
                (_b = _this.buttonContainer.current) === null || _b === void 0
                    ? void 0
                    : _b.querySelector('button')) === null || _c === void 0
                ? void 0
                : _c.focus();
        };
        ...
        _this.getItemElement = function (index) {
            var _a;
            return (_a = _this.gridContainer.current) === null || _a === void 0
                ? void 0
                : _a.querySelector('[data-item-index="'.concat(index, '"]'));
        };
        _this.handleKeydown = function (event) {
            ...
            if (event.code === 'Escape') {
                ...
                ((_c = document.activeElement) === null || _c === void 0
                    ? void 0
                    : _c.getAttribute('data-item-index')) &&
                navKeys.includes(event.code)
            ) {
                var itemIndex = parseInt(
                    activeElement === null || activeElement === void 0
                        ? void 0
                        : activeElement.getAttribute('data-item-index'),
                    10,
                );
                ...
                if (event.code === 'Enter') {
                    ...
                    if (itemIndex < GRID_COLS) {
                        (_e = (_d = _this.searchInput) === null || _d === void 0 ? void 0 : _d.current) === null ||
                        _e === void 0
                            ? void 0
                            : _e.focus();
                        return;
            ...
            React.createElement(
                overlaypanel_1.OverlayPanel,
                {
                    onHide: function () {
                        ...
                        document.removeEventListener('keydown', _this.handleKeydown);
                        (_b =
                            (_a = _this.buttonContainer.current) === null || _a === void 0
                                ? void 0
                ...
                React.createElement(
                    'div',
                    {className: 'select-grid__panel'},
                    React.createElement(
                        'div',
                        {className: 'select-grid__header'},
                        React.createElement(
                            'div',
                            {className: 'sd-searchbar sd-searchbar--boxed'},
