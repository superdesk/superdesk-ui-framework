...
var Alert = /** @class */ (function (_super) {
    ...
    Alert.prototype.render = function () {
        var _a, _b;
        var classesAlert = (0, classnames_1.default)('sd-alert', (_a = {
            ...
            _a));
        var classesInfoBtn = (0, classnames_1.default)('sd-alert__info-btn sd-shadow--z2', (_b = {},
        ...
        return (React.createElement("div", { className: "sd-alert__container", style: styles },
            React.createElement("div", { className: classesAlert },
                this.props.icon ? (React.createElement("span", { className: "sd-alert__icon" },
                    React.createElement(Icon_1.Icon, { name: this.props.icon }))) : null,
                this.props.restoreIcon ? (React.createElement("button", { className: "sd-alert__close", onClick: this.onToggle, "aria-label": "Close" })) : null,
                React.createElement("span", { className: "sd-alert__content" }, this.props.children)),
            this.props.restoreIcon ? (React.createElement("span", { className: classesInfoBtn, onClick: this.onToggle },
