        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                this.props.label && !this.props.isSearchField
                    ? React.createElement(
                          'label',
                          {className: 'sd-input__label', htmlFor: this.htmlId},
                          this.props.label,
                      )
                    : null,
                this.props.label && this.props.isSearchField
                    ? React.createElement('label', {
                          className: 'sd-searchbar__icon',
                          htmlFor: this.htmlId,
                          'aria-label': this.props.label,
                      })
                    : null,
                React.createElement(autocomplete_1.AutoComplete, {
                    id: this.htmlId,
            ...
            this.props.isSearchField
                ? React.createElement(
                      'div',
                      {className: 'sd-searchbar__message-box'},
                      this.props.info && !this.props.invalid && !this.state.invalid
                          ? React.createElement('div', {className: 'sd-searchbar__hint'}, this.props.info)
                          : null,
                      this.props.invalid || this.state.invalid
                          ? React.createElement('div', {className: 'sd-searchbar__message'}, this.props.error)
                          : null,
                  )
                : null,
        );
