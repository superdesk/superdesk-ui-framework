...
var Switch = /** @class */ (function (_super) {
    ...
    Switch.prototype.render = function () {
        ...
        var checkboxInput = React.createElement(
            'span',
            {
                role: 'checkbox',
                id: this.htmlId,
        ...
        if (this.props.label.hidden && typeof this.props.label.content === 'string') {
            return React.createElement(
                Tooltip_1.Tooltip,
                {text: this.props.label.content, flow: this.props.toolTipFlow},
                React.createElement(
                    'span',
                    {className: 'sd-switch__wrapper', tabIndex: -1},
                    checkboxInput,
                    React.createElement(
                        'label',
                        {className: 'a11y-only', htmlFor: this.htmlId},
