...
var ThemeSelector = /** @class */ (function (_super) {
    ...
    ThemeSelector.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(
            ...
            ((_a = {}), (_a['sd-theme-selector__list--'.concat(this.props.size)] = this.props.size), _a),
        );
        return React.createElement(
            ...
            this.props.options.map(function (item, index) {
                return React.createElement(
                    'div',
                    {className: 'sd-theme-selector__item', key: index, tabIndex: -1},
                    React.createElement(
                        'figure',
                        {
                        ...
                        React.createElement(
                            'svg',
                            {viewBox: '0 0 156 94', xmlns: 'http://www.w3.org/2000/svg'},
                            React.createElement(
                                'g',
                                {fill: 'none', fillRule: 'evenodd'},
                                React.createElement('path', {
                                    d: 'm0 0h156v94h-156z',
                                    fill: 'var(--sd-colour-panel-bg--100)',
                                }),
                                ...
                                React.createElement(
                                    'g',
                                    {fill: 'var(--sd-colour-btn-bg-neutral)'},
                                ...
                                React.createElement('path', {
                                    d: 'm0 22h22v72h-22z',
                                    fill: 'var(--sd-colour-sidebar-menu--00)',
                                }),
                                React.createElement('circle', {
                                    cx: '11',
                                    cy: '52',
                                ...
                                React.createElement(
                                    'g',
                                    {fill: 'var(--color-icon-default)', opacity: '.75'},
                                    React.createElement('circle', {cx: '11', cy: '34', r: '6'}),
                                    React.createElement('circle', {cx: '11', cy: '70', r: '6'}),
                                ),
                                React.createElement('path', {
                                    d: 'm0 0h156v22h-156z',
                                    fill: 'var(--sd-colour-top-menu)',
                                }),
                                React.createElement('path', {
                                    d: 'm0 22h156v1h-156z',
                                    fill: 'var(--sd-colour--shadow-line)',
                                }),
                                React.createElement(
                                    'g',
                                    {fill: 'hsla(214, 13%, 65%, 1)', opacity: '1'},
                                    React.createElement('rect', {height: '4', rx: '2', width: '11', x: '31', y: '9'}),
                                    React.createElement('rect', {height: '4', rx: '2', width: '23', x: '45', y: '9'}),
                                ),
                                React.createElement('path', {
                                    d: 'm22 44h134v1h-134z',
                                    fill: 'var(--sd-colour-line--medium)',
                                }),
                                React.createElement('path', {
                                    d: 'm0 0h22v22h-22z',
                                    fill: 'var(--sd-colour-top-menu__btn)',
                                }),
                                React.createElement('path', {
                                    d: 'm15 13v1h-8v-1zm0-3v1h-8v-1zm0-3v1h-8v-1z',
                                    fill: '#fff',
                                }),
                            ),
                        ),
                    ...
                    React.createElement(
                        'div',
                        {className: 'sd-theme-selector__item-action'},
                        ...
                        React.createElement(
                            'label',
                            {className: 'sd-theme-selector__label', htmlFor: _this.htmlId + index},
                            item.label,
                        ),
                        React.createElement(
                            'span',
                            {className: 'sd-theme-selector__label-text', 'aria-hidden': 'true'},
                            item.label,
                        ),
                    ),
                );
