...
exports.BoxedListFooter =
    exports.BoxedListActions =
...
var BoxedListItem = /** @class */ (function (_super) {
    ...
    BoxedListItem.prototype.handleClick = function (event) {
        var _a, _b, _c;
        if (
            ((_a = this.actionsRef) === null || _a === void 0 ? void 0 : _a.rootElement) != null &&
            this.actionsRef.rootElement.contains(event.target)
        ) {
            return;
        } else {
    ...
    BoxedListItem.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(
            ...
            (_a['boxed-list__item--'.concat(this.props.density)] =
                this.props.density || this.props.density !== undefined),
