                      ...
                      React.createElement(
                          ...
                          function (provided, _snapshot) {
                              return React.createElement(
                                  'div',
                                  __assign(
                                      {role: 'list', className: classes, ref: provided.innerRef},
                                      provided.droppableProps,
                                  ),
                                  _this.state.items.map(function (item, index) {
                                      return React.createElement(
                                          react_beautiful_dnd_1.Draggable,
                                          {key: index, draggableId: ''.concat(index), index: index},
                                          function (provided2, snapshot) {
                                              return _this.props.append
                                  ...
                                  _this.props.addItem &&
                                      ...
                                      React.createElement(
                                          'div',
                                          {className: 'table-list__add-item table-list__item--margin'},
                                          React.createElement(
                                              Tooltip_1.Tooltip,
                                              {text: 'Add item', flow: 'top'},
                                              React.createElement(
                                                  'div',
                                                  {className: 'table-list__add-item--container sd-margin-x--auto'},
                                                  _this.dropDown(),
                                              ),
                                          ),
                                      ),
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('div', {
                        className: 'table-list__item-border',
                        style: {backgroundColor: this.props.hexColor},
                    }),
                    React.createElement(
                        'div',
                        {className: 'table-list__item-content'},
                        React.createElement(
                            'div',
                            {className: 'table-list__item-content-block'},
                            this.props.start && this.props.start,
                        ),
                        React.createElement(
                            'div',
                            {className: 'table-list__item-content-block table-list__item-content-block--center'},
                    ...
                    this.props.action &&
                        React.createElement(
                            'div',
                            {className: 'table-list__slide-in-actions', onClick: this.onActionMenuClick},
                            this.props.action,
                        ),
                ),
                this.props.addItem &&
                    React.createElement(
                        'div',
                        {className: 'table-list__add-bar-container'},
                        React.createElement(
                            Tooltip_1.Tooltip,
                            {text: 'Add item', flow: 'top'},
                            React.createElement(
                                'div',
                                {className: 'table-list__add-bar'},
                                React.createElement(
                                    Dropdown_1.Dropdown,
                                    {
...
var PortalItem = /** @class */ (function (_super) {
    ...
    PortalItem.prototype.render = function () {
        ...
        var child = React.createElement(
            'div',
            __assign({ref: provided.innerRef}, provided.draggableProps, provided.dragHandleProps),
            React.createElement(TableListItem, {
                ...
                onDoubleClick: this.props.item.onDoubleClick ? this.props.item.onDoubleClick : undefined,
