...
var ContentListItem = /** @class */ (function (_super) {
    ...
    ContentListItem.prototype.render = function () {
        ...
        return React.createElement(
                ...
                return React.createElement(
                    'div',
                    {
                        className: '\n                            sd-list-item__column\n                            '
                            ...
                            .concat(!item.border && 'sd-list-item__column--no-border'),
                        key: index,
                    },
                    item.itemRow.map(function (e, i) {
            ...
            React.createElement(
                'div',
                {className: 'sd-list-item__action-menu', onClick: this.onActionMenuClick},
                this.props.action,
            ),
        );
    };
    ...
    ContentList.prototype.render = function () {
        ...
        return React.createElement(
            ...
            this.props.items.map(function (item, index) {
                return React.createElement(ContentListItem, {
                    key: index,
