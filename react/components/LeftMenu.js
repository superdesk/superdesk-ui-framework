...
var LeftMenu = /** @class */ (function (_super) {
    ...
    LeftMenu.prototype.render = function () {
        ...
        var scrollspyList = function () {
            ...
            return (React.createElement(react_scrollspy_1.default, { offset: _this.props.offset ? _this.props.offset : -300, items: scrollSpyList, rootEl: _this.props.scrollSpy, currentClassName: "sd-left-nav__btn--active" }, scrollSpyItems.map(function (element) { return element; })));
        };
        ...
        return (React.createElement("nav", { className: classes, "aria-label": this.props.ariaLabel }, this.props.scrollSpy ? scrollspyList() : defaultList()));
    };
    return LeftMenu;
}(React.PureComponent));
