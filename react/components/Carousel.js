...
var Carousel = /** @class */ (function (_super) {
    ...
    Carousel.prototype.render = function () {
        var header = React.createElement(
            'div',
            {className: 'sd-thumb-carousel__header'},
            this.props.title &&
                React.createElement(
                    React.Fragment,
                    null,
                    ...
                    React.createElement(Badge_1.Badge, {
                        text: '' + (this.props.imageCount || this.props.images.length),
                        type: 'light',
                    }),
                ),
            this.props.headerMeta &&
                React.createElement('div', {className: 'sd-thumb-carousel__header-block--r'}, this.props.headerMeta),
        );
        var footer = this.props.description
            ? React.createElement('div', {className: 'sd-thumb-carousel__description'}, this.props.description)
            : null;
        ...
        return React.createElement(
            ...
            React.createElement(carousel_1.Carousel, {
                id: this.props.id,
