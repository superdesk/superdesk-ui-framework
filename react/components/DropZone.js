    ...
    DropZone.prototype.render = function () {
        ...
        return React.createElement(
            ...
            this.props.icon
                ? React.createElement(
                      'figure',
                      {className: 'sd-dropzone__icon', 'aria-hidden': 'true'},
                      React.createElement(Icon_1.Icon, {name: 'upload-alt', size: 'big'}),
                  )
                : null,
            this.props.heading
                ? React.createElement('h4', {className: 'sd-dropzone__heading'}, this.props.heading)
                : null,
