    ...
    TreeSelectPill.prototype.render = function () {
        ...
        return (React.createElement("li", { className: classes, style: this.props.valueTemplate
            ...
            React.createElement("span", { className: "tags-input__helper-box", style: {
                ...
                this.props.children,
                !this.props.readOnly && (React.createElement("button", { className: "tags-input__remove-button", "data-test-id": "remove", onClick: function () { return !_this.props.readOnly && !_this.props.disabled && _this.props.onRemove(); } },
