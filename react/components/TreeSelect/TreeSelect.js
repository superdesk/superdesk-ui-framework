...
var TreeSelect = /** @class */ (function (_super) {
        ...
        if (this.props.kind === 'synchronous') {
            ...
            if (filteredArr.length === 0) {
                ...
                return filteredArr.map(function (option, i) {
                    ...
                    return (React.createElement(TreeSelectItem_1.TreeSelectItem, { key: i, option: option, handleTree: _this.handleTree, selectedItem: selectedItem, allowMultiple: _this.props.allowMultiple, getBorderColor: _this.props.getBorderColor, getBackgroundColor: _this.props.getBackgroundColor, getId: _this.props.getId, optionTemplate: _this.props.optionTemplate, getLabel: _this.props.getLabel, onClick: function () {
            ...
            if (this.state.options.length > 0) {
                return this.state.options.map(function (item, i) {
                    var selectedItem = _this.state.value.some(function (obj) { return _this.props.getId(obj) === _this.props.getId(item.value); });
                    return (React.createElement("li", { key: i, className: "suggestion-item suggestion-item--multi-select", onClick: function (event) {
                        ...
                        React.createElement("button", { className: "suggestion-item--btn", "data-test-id": "option" }, _this.props.optionTemplate ? (_this.props.optionTemplate(item.value)) : (React.createElement("span", { className: selectedItem ? 'suggestion-item--selected' : undefined }, _this.props.getLabel(item.value))))));
                });
            }
            else {
    ...
    TreeSelect.prototype.branchButton = function (buttonValue) {
        ...
        var selectedButton = this.state.value.some(function (obj) { return _this.props.getId(obj) === _this.props.getId(buttonValue.value); });
        if (!selectedButton) {
    ...
    TreeSelect.prototype.render = function () {
        ...
        return (React.createElement(Form_1.InputWrapper, { label: this.props.label, error: this.props.error, invalid: this.props.error != null, required: this.props.required, disabled: this.props.disabled, info: this.props.info, inlineLabel: this.props.inlineLabel, labelHidden: this.props.labelHidden, htmlId: this.htmlId, tabindex: this.props.tabindex, fullWidth: this.props.fullWidth, "data-test-id": this.props['data-test-id'], inputWrapper: this.props.inputWrapper },
            React.createElement("div", { className: "\n                        tags-input sd-input__input\n                        tags-input--".concat(this.props.allowMultiple ? 'multi-select' : 'single-select'), ref: this.treeSelectRef, "data-test-id": this.props.allowMultiple ? undefined : 'open-popover' }, this.props.allowMultiple ? (React.createElement("div", { className: "tags-input__tags" },
                this.props.readOnly || (React.createElement("button", { ref: this.openDropdownRef, className: "\n                                        tags-input__add-button\n                                        ".concat(this.props.disabled ? 'tags-input__add-button--disabled' : ''), onClick: function (e) {
                        e.stopPropagation();
                ...
                this.state.value.length > 0
                    ? this.props.readOnly ||
                        this.props.disabled || (React.createElement("button", { className: "tags-input__remove-value", style: { position: 'relative', bottom: '2px' }, onClick: function (e) {
                            e.stopPropagation();
                            _this.setState({ value: [] });
                        } },
                        React.createElement(Icon_1.Icon, { name: "remove-sign" })))
                    : null)) : (React.createElement("div", { className: "tags-input__tags" },
                this.props.readOnly || (React.createElement("button", { className: "tags-input__overlay-button", ref: this.openDropdownRef, onClick: function () {
                ...
                this.state.value.map(function (item, i) {
                    var Wrapper = function (_a) {
                        ...
                        return (React.createElement("span", { className: 'tags-input__single-item' +
                            ...
                            _this.props.getBorderColor && (React.createElement("div", { className: "item-border item-border-selected", style: borderColor
                ...
                React.createElement("div", { className: 'autocomplete autocomplete--multi-select' +
                    ...
                    this.state.loading ? (React.createElement("ul", { className: "suggestion-list--loader" },
                        ...
                        return (React.createElement(TreeSelectItem_1.TreeSelectItem, { key: i, option: option, handleTree: _this.handleTree, selectedItem: selectedItem, allowMultiple: _this.props.allowMultiple, parentCategory: _this.state.buttonValue == null
                                ? undefined
                                : _this.props.getLabel(_this.state.buttonValue.value), getBorderColor: _this.props.getBorderColor, getBackgroundColor: _this.props.getBackgroundColor, getId: _this.props.getId, getLabel: _this.props.getLabel, optionTemplate: _this.props.optionTemplate, onKeyDown: function () {
                                return _this.setState({
