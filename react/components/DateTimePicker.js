...
var DateTimePicker = /** @class */ (function (_super) {
    ...
    function DateTimePicker() {
        ...
        _this.handleTimeChange = function (time) {
            if (_this.props.valueType === 'date') {
                var _a = time.split(':').map(function (x) {
                        return (0, lodash_1.defaultTo)(parseInt(x, 10), 0);
                    }),
                    hours = _a[0],
                    minutes = _a[1];
        ...
        _this.handleDateChange = function (date) {
            ...
            if (_this.props.valueType === 'date') {
                ...
                _this.props.onChange(
                    __assign(__assign({}, _this.props.value), {
                        date: date ? (0, date_fns_1.format)(date, 'yyyy-MM-dd') : undefined,
                    }),
                );
            } else {
                (0, helpers_1.assertNever)(_this.props);
    ...
    DateTimePicker.prototype.getTimeValue = function () {
        ...
        if (this.props.valueType === 'date') {
            return this.props.value != null
                ? ''
                      .concat(this.prepareFormat(this.props.value.getHours()), ':')
                      .concat(this.prepareFormat(this.props.value.getMinutes()))
                : null;
    ...
    DateTimePicker.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                common_1.Spacer,
                {h: true, gap: '8', alignItems: 'end', noWrap: true},
                React.createElement(
                    'div',
                    {style: {flexGrow: 1}},
                ...
                React.createElement(
                    'div',
                    {style: {flexGrow: 1}},
                    React.createElement(TimePicker_1.TimePicker, {
