...
var SideBarMenu = /** @class */ (function (_super) {
    ...
    SideBarMenu.prototype.render = function () {
        ...
        return React.createElement(
            'div',
            {className: 'sd-sidebar-menu sd-content-wrapper__left-tabs'},
            React.createElement(
                'ul',
                {className: 'authoring-active'},
                    ...
                    if (item === 'divider') {
                        ...
                        return React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'span',
                                    {className: 'sd-sidebar-menu__main-icon '},
                                    React.createElement(Icon_1.Icon, {size: item['size'], name: item['icon']}),
                                ),
                                React.createElement('i', {
                                    className: 'sd-sidebar-menu__helper-icon big-icon--chevron-left',
                                }),
                            ),
                        );
                    }
