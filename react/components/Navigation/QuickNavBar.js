...
var QuickNavBar = /** @class */ (function (_super) {
    ...
    QuickNavBar.prototype.handleClick = function (item, indexNumber, event) {
        ...
        if (item.id && this.props.scrollSpy) {
            return (_a = document.getElementById(item.id)) === null || _a === void 0
                ? void 0
                                  ...
                                  return React.createElement(
                                      ...
                                      React.createElement(
                                          'a',
                                          {
                                              ...
                                              className: 'sd-quickbar__btn',
                                              onClick: function () {
                                                  return _this.handleClick(item, index, event);
                                              },
                                          },
                ...
                : React.createElement(
                      ...
                      this.props.items.map(function (item, index) {
                          if (item === 'divider') {
                              ...
                              return React.createElement(
                                  'li',
                                  {key: index, 'data-sd-tooltip': item['tooltip'], 'data-flow': 'right'},
                                  React.createElement(
                                      'a',
                                      {
                                          role: 'button',
                                          ...
                                          className:
                                              'sd-quickbar__btn' +
                                              (index === _this.state.index ? ' sd-quickbar__btn--active' : ''),
                                          onClick: function () {
                                              return _this.handleClick(item, index, event);
                                          },
                                      },
