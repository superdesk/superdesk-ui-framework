...
var SideBarTabs = /** @class */ (function (_super) {
    ...
    SideBarTabs.prototype.componentDidMount = function () {
        var _this = this;
        var activeItem = this.props.items.find(function (item) {
            return item !== 'divider' && item.id === _this.props.activeTab;
        });
    ...
    SideBarTabs.prototype.render = function () {
        ...
        return React.createElement(
            'div',
            {className: 'sd-sidetab-menu sd-sidetab-menu--static', 'data-test-id': this.props['data-test-id']},
            React.createElement(
                'ul',
                null,
                this.props.items.map(function (item, index) {
                    if (item === 'divider') {
                        ...
                        return React.createElement(
                            'li',
                            {key: index, 'data-sd-tooltip': item.tooltip, 'data-flow': 'left'},
                            React.createElement(
                                'button',
                                {
                                    ...
                                    className: (0, classnames_1.default)('sd-sidetab-menu__btn', {
                                        'sd-sidetab-menu__btn--active':
                                            item.id === _this.props.activeTab && _this.props.disabled !== true,
                                    }),
                                    onClick: function () {
                                ...
                                React.createElement(
                                    'span',
                                    {className: 'sd-sidetab-menu__main-icon '},
