...
var DragHandle = /** @class */ (function (_super) {
    ...
    DragHandle.prototype.render = function () {
        ...
        return React.createElement(
            'div',
            {className: classes},
            React.createElement(DragHandleDots_1.DragHandleDots, {
                style: {
                    width: calcSize((_b = this.props.dotsInRow) !== null && _b !== void 0 ? _b : '2'),
                    height: calcSize((_c = this.props.dotRows) !== null && _c !== void 0 ? _c : '4'),
                },
