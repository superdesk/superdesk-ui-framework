...
var ContentDivider = /** @class */ (function (_super) {
    ...
    ContentDivider.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(
            ...
            (_a['sd-content-divider--text-'.concat(this.props.align)] =
                this.props.align || this.props.align !== undefined),
            (_a['sd-content-divider--'.concat(this.props.orientation)] =
                this.props.orientation || this.props.orientation !== undefined),
            (_a['sd-content-divider--margin-medium'] = this.props.margin === undefined),
            (_a['sd-content-divider--margin-'.concat(this.props.margin)] =
                this.props.margin || this.props.margin !== undefined),
            _a),
        );
        if (this.props.children) {
            return React.createElement(
                'div',
                {className: 'sd-content-divider--with-text ' + classes, role: 'separator'},
