...
var Popover = /** @class */ (function (_super) {
    ...
    Popover.prototype.render = function () {
        ...
        return React.createElement(
            _Positioner_1.Positioner,
            {
                triggerSelector: this.props.triggerSelector,
                placement: (_a = this.props.placement) !== null && _a !== void 0 ? _a : 'auto',
                className: 'sd-popover',
            },
            React.createElement(
                'div',
                {className: 'sd-popover__header'},
                React.createElement(
                    'h4',
                    {className: 'sd-popover__title', tabIndex: 0, id: 'popoverTitle'},
                    this.props.title,
                ),
                ((_b = this.props.displayCloseButton) !== null && _b !== void 0 ? _b : true) &&
                    React.createElement(
                        'button',
                        {
