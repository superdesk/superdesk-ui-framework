...
var Tabs = function (props) {
    var _a;
    var initiallySelectedIndex = props.initiallySelectedIndex,
        size = props.size,
        theme = props.theme,
    ...
    var _b = React.useState(
            initiallySelectedIndex !== null && initiallySelectedIndex !== void 0 ? initiallySelectedIndex : 0,
        ),
        index = _b[0],
        setIndex = _b[1];
...
var TabContent = function (_a) {
    var theme = _a.theme,
        ...
        activePanel = _a.activePanel;
    return React.createElement(
        'div',
        {className: 'sd-nav-tabs__content' + (theme === 'dark' ? ' sd-nav-tabs__content--ui-dark' : '')},
        children.map(function (panel, i) {
            return (
                panel.props.indexValue === activePanel &&
                React.createElement(
                    'div',
                    {className: 'sd-nav-tabs__pane', role: 'tabpanel', 'aria-labelledby': 'tab-' + activePanel, key: i},
                    panel,
                )
            );
        }),
