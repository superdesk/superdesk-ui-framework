        ...
        _this.onMouseDown = function (event) {
            ...
            if (
                ((_a = _this.dropdownRef.current) === null || _a === void 0 ? void 0 : _a.contains(event.target)) !==
                    true &&
                ((_b = _this.treeMenuRef.current) === null || _b === void 0 ? void 0 : _b.contains(event.target)) !==
                    true &&
    ...
    TreeMenu.prototype.filteredItem = function (arr) {
        ...
        var filteredArr = arr.filter(function (item) {
            if (_this.state.searchFieldValue) {
                if (
                    _this.props.getLabel(item.value).toLowerCase().includes(_this.state.searchFieldValue.toLowerCase())
                ) {
                    return item.value;
                } else {
                    return;
    ...
    TreeMenu.prototype.render = function () {
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                {active: this.state.openDropdown, 'data-test-id': 'tree-menu-popover'},
                React.createElement(
                    'div',
                    {
