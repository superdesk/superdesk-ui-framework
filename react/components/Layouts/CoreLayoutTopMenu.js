...
var CoreLayoutTopMenu = /** @class */ (function (_super) {
    ...
    CoreLayoutTopMenu.prototype.render = function () {
        return React.createElement(
            'header',
            {className: 'sd-top-menu', 'data-theme': 'dark-ui'},
            React.createElement(_1.HamburgerButton, {
            ...
            React.createElement(
                _2.Container,
                {className: 'sd-margin-e--auto'},
                this.props.heading && React.createElement('p', {className: 'sd-top-menu__header'}, this.props.heading),
            ),
            this.props.children,
        );
    };
...
exports.CoreLayoutTopMenu = CoreLayoutTopMenu;
