...
var AuthoringMain = /** @class */ (function (_super) {
    ...
    AuthoringMain.prototype.render = function () {
        return React.createElement(
            _1.AuthoringMainContainer,
            null,
            this.props.toolBar &&
                React.createElement(
                    _1.AuthoringMainToolBar,
                    {toolbarCustom: this.props.toolbarCustom},
                    this.props.toolBar,
                ),
            React.createElement(
                _1.AuthoringMainContent,
                null,
                this.props.authoringHeader &&
                    React.createElement(
                        _1.AuthoringInnerHeader,
                        {
                ...
                this.props.authoringBookmarks &&
                    React.createElement(_1.AuthorinInnerSideBar, null, this.props.authoringBookmarks),
                React.createElement(
                    _1.AuthoringInnerBody,
                    {noPadding: this.props.noPaddingForContent},
                    this.props.children,
                ),
            ),
        );
...
exports.AuthoringMain = AuthoringMain;
