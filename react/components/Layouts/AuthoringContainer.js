...
var AuthoringContainer = /** @class */ (function (_super) {
    ...
    AuthoringContainer.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(
            ...
            (_a['sd-content-wrapper__authoring-content-area--'.concat(this.props.background)] =
                this.props.background !== 'light' && this.props.background !== undefined),
            (_a['open-editor'] = this.props.open),
            _a),
        );
        var classesContainerInner = (0, classnames_1.default)(
            'sd-editor__container',
            ((_b = {}), (_b['sd-editor__container--large'] = this.props.large), _b),
        );
        return React.createElement(
            ...
            React.createElement(
                'div',
                {className: 'sd-editor__container-wrapper'},
