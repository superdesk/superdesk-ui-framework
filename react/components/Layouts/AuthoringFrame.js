    ...
    AuthoringFrame.prototype.render = function () {
        return React.createElement(
            ...
            this.props.sidePanel &&
                React.createElement(
                    _1.AuthoringFrameSidePanel,
                    {opened: this.props.sidePanelOpen, pinned: this.props.sidePanelPinned},
                    this.props.sidePanel,
                ),
            this.props.sideOverlay &&
                React.createElement(
                    _1.AuthoringFrameSidePanelOverlay,
                    {opened: this.props.sideOverlayOpen},
                    this.props.sideOverlay,
                ),
            this.props.sideBar &&
                React.createElement(_1.AuthoringFrameRightBar, {closed: this.props.sideBarClosed}, this.props.sideBar),
            this.props.overlayPanel && React.createElement(_1.AuthoringFrameOverlay, null, this.props.overlayPanel),
        );
    };
    return AuthoringFrame;
})(React.PureComponent);
exports.AuthoringFrame = AuthoringFrame;
