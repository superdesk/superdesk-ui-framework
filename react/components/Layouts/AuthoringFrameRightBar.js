...
exports.AuthoringFrameRightBar = void 0;
...
var AuthoringFrameRightBar = /** @class */ (function (_super) {
    ...
    AuthoringFrameRightBar.prototype.render = function () {
        return (
            !this.state.closed &&
            React.createElement('div', {className: 'sd-editor-grid__sidetabs-bar'}, this.props.children)
        );
    };
    return AuthoringFrameRightBar;
})(React.PureComponent);
exports.AuthoringFrameRightBar = AuthoringFrameRightBar;
