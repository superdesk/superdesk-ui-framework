...
var PanelHeader = /** @class */ (function (_super) {
    ...
    PanelHeader.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)('side-panel__header side-panel__header--border-b', (_a = {},
...
var PanelTools = /** @class */ (function (_super) {
    ...
    PanelTools.prototype.render = function () {
        return (React.createElement("div", { className: "side-panel__tools" }, this.props.tools.map(function (tool) { return (React.createElement(IconButton_1.IconButton, { key: tool.title, id: tool.title, icon: tool.icon, ariaValue: tool.ariaValue, onClick: tool.onClick })); })));
    };
    return PanelTools;
}(React.PureComponent));
