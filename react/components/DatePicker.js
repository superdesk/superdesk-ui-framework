    ...
    DatePicker.prototype.render = function () {
            ...
            return (
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'span',
                        null,
                        (0, moment_1.default)(this.state.value).format(this.props.dateFormat),
                    ),
                )
            );
        }
        var locale = (function () {
            if (_this.props.locale == null) {
                ...
                return __assign(__assign({}, _this.props.locale.payload), {
                    today: localization_1.localization.translations.today,
                    clear: localization_1.localization.translations.clear,
                });
            } else {
        ...
        return React.createElement(
            ...
            React.createElement(calendar_1.Calendar, {
                ...
                ref: function (ref) {
                    ...
                    var refAny = ref;
                    if (
                        _this.props['data-test-id'] != null &&
                        (refAny === null || refAny === void 0 ? void 0 : refAny.inputElement) != null
                    ) {
                ...
                headerTemplate: function () {
                    return _this.props.headerButtonBar == null
                        ? null
                        : React.createElement(
                              'div',
                              {className: 'datepicker-header-toolbar'},
                              _this.props.headerButtonBar.map(function (_a, i) {
                                  var label = _a.label,
                                      days = _a.days;
                                  return React.createElement(
                                      'button',
