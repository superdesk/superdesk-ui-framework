...
var DropdownFirst = function (_a) {
    ...
    var classes = (0, classnames_1.default)('dropdown', (_b = {},
        _b['open'] = open,
    ...
    if (headerFooter) {
        return (React.createElement("div", { className: classes },
            React.createElement("button", { className: navDropdown
                    ...
                    : 'dropdown__toggle nav-btn dropdown-toggle', onClick: isOpen }, icon ? (React.createElement("i", { className: 'icon-' + icon })) : (React.createElement(React.Fragment, null,
                name,
        ...
        if (level) {
            var classesMenu = (0, classnames_1.default)('dropdown__menu', (_c = {},
