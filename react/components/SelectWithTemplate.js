...
var SelectWithTemplate = /** @class */ (function (_super) {
    ...
    SelectWithTemplate.prototype.render = function () {
        ...
        var _c = this.props,
            ...
            areEqual = _c.areEqual,
            getItems = _c.getItems,
            emptyFilterMessage = _c.noResultsFoundMessage,
            filterPlaceholder = _c.filterPlaceholder,
            width = _c.width;
        ...
        var optionsInternal = options.map(function (option) {
            return toInternalStructure(option);
        });
        var valueInternal =
            value == null
                ? null
                : (_a =
                        optionsInternal === null || optionsInternal === void 0
                            ? void 0
                            : optionsInternal.find(function (_a) {
                                  var original = _a.original;
                                  return areEqual(original, value);
                              })) !== null && _a !== void 0
                  ? _a
                  : toInternalStructure(value);
            ...
            React.createElement(dropdown_1.Dropdown, {
                ...
                itemTemplate: function (option) {
                    ...
                    return React.createElement(ItemTemplate, {
                        option:
                            (_a = option === null || option === void 0 ? void 0 : option.original) !== null &&
                            _a !== void 0
                                ? _a
                                : null,
                    });
                },
                valueTemplate: function (option) {
                    var _a, _b;
                    return ValueTemplate != null
                        ? React.createElement(ValueTemplate, {
                              option:
                                  (_a = option === null || option === void 0 ? void 0 : option.original) !== null &&
                                  _a !== void 0
                                      ? _a
                        ...
                        : React.createElement(ItemTemplate, {
                              option:
                                  (_b = option === null || option === void 0 ? void 0 : option.original) !== null &&
                                  _b !== void 0
                                      ? _b
                                      : null,
                          });
                ...
                loading: loading,
                onFilterInputChange: function (searchString) {
