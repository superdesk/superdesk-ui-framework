...
var SvgIconIllustration = /** @class */ (function (_super) {
        ...
        switch (this.props.illustration) {
            ...
            case 'keywords':
                return React.createElement(
                    ...
                    React.createElement(
                        'g',
                        {clipPath: 'url(#clip0_1814_54108)'},
                        React.createElement(
                            'g',
                            {clipPath: 'url(#clip1_1814_54108)'},
                            React.createElement('rect', {
                                x: '21',
                                y: '5',
                                width: '22',
            ...
            case 'optimise':
                return React.createElement(
                    ...
                    React.createElement(
                        'g',
                        {clipPath: 'url(#clip0_1814_54107)'},
                        React.createElement(
                            'g',
                            {clipPath: 'url(#clip1_1814_54107)'},
                            React.createElement('path', {
            ...
            case 'summary':
                return React.createElement(
                    ...
                    React.createElement(
                        'g',
                        {clipPath: 'url(#clip0_1814_54105)'},
                        React.createElement(
                            'g',
                            {clipPath: 'url(#clip1_1814_54105)'},
                            React.createElement('path', {
                                fillRule: 'evenodd',
                                clipRule: 'evenodd',
    ...
    SvgIconIllustration.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(
            ...
            ((_a = {}), (_a['svg-icon-illustration--'.concat(this.props.illustration)] = this.props.illustration), _a),
        );
