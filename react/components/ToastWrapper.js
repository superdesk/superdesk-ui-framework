        ...
        _this.notify = function (message, options) {
            ...
            _this.setState(function (prev) {
                ...
                return __assign(
                    ...
                    ((_a = {}),
                    (_a[position] = isTop
                        ? __spreadArray([toast], prev[position], true)
                        : __spreadArray(__spreadArray([], prev[position], true), [toast], false)),
                    _a),
                );
            });
        ...
        _this.requestClose = function (id, position) {
            _this.setState(function (prev) {
                ...
                return __assign(
                    __assign({}, prev),
                    ((_a = {}),
                    (_a[position] = prev[position].filter(function (toast) {
                        return toast.id !== id;
                    })),
                    _a),
                );
    ...
    ToastWrapper.prototype.render = function () {
        ...
        return Object.keys(this.state).map(function (position) {
            ...
            return React.createElement(
                'div',
                {key: position, className: 'sd-toast__container sd-toast__container--' + pos},
                (pos === 'top' ? toasts : __spreadArray([], toasts, true).reverse()).map(function (toast) {
                    return React.createElement(ToastMessage_1.ToastMessage, {
                        position: pos,
                        type: toast.type,
                        icon: toast.icon,
                        closeElement: _this.requestClose,
